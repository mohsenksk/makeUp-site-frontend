      ...
      <div className="mx-6 py-3 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">محصولات3</a>
            </p>
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">محصولات1</a>
            </p>
          </div>
